...
class AnswerChoicesAdapter(
    private var answerChoiceList: ArrayList<AnswerChoice>
) : RecyclerView.Adapter<AnswerChoicesAdapter.DataViewHolder>() {


    lateinit var itemClickListener: ItemClickListener<AnswerChoice>
    ...
    class DataViewHolder(private val binding: LayoutAnswerChoicesBinding) :
        ...
        fun bind(
            ...
            itemClickListener: ItemClickListener<AnswerChoice>
        ) {
    ...
    fun addData(list: List<AnswerChoice>) {
